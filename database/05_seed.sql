...
-- =====================================================================
--  (1) الأدوار السبعة (roles)
-- =====================================================================
INSERT INTO roles (name, description) VALUES
    ('admin',          'مدير النظام: إدارة المستخدمين والأدوار والصلاحيات والكتالوجات'),
    ('doctor',         'الطبيب: السجلات الطبية والتشخيصات والوصفات وطلبات الفحص'),
    ('nurse',          'الممرّض: العلامات الحيوية وحالة المواعيد ضمن نطاق الرعاية'),
    ('receptionist',   'موظف الاستقبال: المرضى والمواعيد والفواتير والمدفوعات'),
    ('lab_technician', 'فنّي المختبر: تنفيذ طلبات الفحص وإدخال النتائج'),
    ('pharmacist',     'الصيدلي: صرف الوصفات وإدارة مخزون الأدوية'),
    ('patient',        'المريض: الاطّلاع على سجله الشخصي وحجز مواعيده');
